...
//跳转复课页面，有限制条件，已经复课和终止不能复课（超期这里有小问题，带完善）
...
function addLeaveSubmit()
{
	if($("#addLeaveForm").form('validate')){
		...
		var json = '{"studentId":"'+studentId+'","studentCourseId":"'+studentCourseId+'","leaveState":"001","leaveTime":"'+planLeaveTime+'","orignCourseState":"'+courseState+'","hours":"'+currentHours+'","leaveReason":"'+addRemark+'","handlerId":"'+handlerId+'","createDate":"'+createDate+'","leaveDate":"'+leaveDate+'"}';
		$.ajax({
			type : "POST",
