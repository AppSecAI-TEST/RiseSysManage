	...
	<body>
		...
		<input id="handlerId" type="hidden" value="${sessionScope.StaffT.staffId}"/>
  			<table id ="infoTab" width="100%;" class="maintable">
  				...
  				<tr>
  					<td width="5%"  align="center"><span>月份</span></td>
  				...
  				<tr month="1" days="" class="addTr">
  					...
  					<td align="center">
  						<a href="javascript:void(0)" onclick="toaddDays(this)" class="easyui-linkbutton" iconCls="icon-add" plain="true"><span>添加</span></a>
  					</td>
  					<td><span></span></td>
  				</tr>
