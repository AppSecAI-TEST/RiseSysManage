		...
		<table class="tab" id="studentTab" style="width:99%;margin:5px auto;padding:0 0;border-top:1px solid #ccc;border-left:1px solid #ccc;" border="0" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${schooltimeInstT.classInstT.classStudentList}" var="node" varStatus="i">
				<tr>
					...
					<td align="center"><input type="radio" name="attendType" id="attendType${node.classStudentId}1" value="N" checked="checked" /><label for="attendType${node.classStudentId}1">正常上课</label>&nbsp;<input type="radio" name="attendType" id="attendType${node.classStudentId}2" value="B" /><label for="attendType${node.classStudentId}2">迟到</label>&nbsp;<input type="radio" name="attendType" id="attendType${node.classStudentId}3" value="L" /><label for="attendType${node.classStudentId}3">请假</label>&nbsp;<input type="radio" name="attendType" id="attendType${node.classStudentId}4" value="T" /><label for="attendType${node.classStudentId}4">旷课</label>&nbsp;&nbsp;&nbsp;&nbsp;<input class="easyui-filebox" name="uploadAttenceLeave" data-options="prompt:'',buttonText:'上传请假单'" style="width:200px"></td>
					<td align="center"><input type="radio" name="dress" id="dress${node.classStudentId}1" value="N" checked="checked" /><label for="dress${node.classStudentId}1">未穿校服</label>&nbsp;&nbsp;<input type="radio" name="dress" id="dress${node.classStudentId}2" value="Y" /><label for="dress${node.classStudentId}2">已穿校服</label></td>
				</tr>
			</c:forEach>
		</table>
