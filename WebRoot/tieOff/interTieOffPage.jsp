  	...
  	<body>
  		<div style="padding:5px 0;">
			...
			<div style="padding:5px 0;min-width:1100px; width:100%;">
				<table class="easyui-datagrid" style="height:435px;" id="list_data" title="查询结果" toolbar="#toolbar" pagination="false" rownumbers="true" fitColumns="true" singleSelect="false">
					<thead>
						<tr>
							<th field="schoolName" align="center" width="14%">校区</th>
							<th field="className" align="center" width="14%">国际班级名称</th>
							<th field="openDate" align="center" width="14%">开课日期</th>
							<th field="finishDate" align="center" width="14%">结课日期</th>
							<th field="monthDate" align="center" width="14%">月份</th>
							<th field="handlerName" align="center" width="14%">操作人</th>
							<th field="createDate" align="center" width="14%">操作时间</th>
						</tr>
					</thead>
				</table>
			</div>
		...
		<script language="javascript">
			...
			function queryFunc()
			{
				...
				obj["queryCode"] = "qryInterTieOffList";
				obj["funcNodeId"] = "38143";
			...
			{
				ajaxLoading("加载中...");
				window.location.href = "/sys/incomeFinish/accessRecordPage.do?incomeFlag=inter";
			}
		</script>
  	</body>
</html>