  			...
  			<form id="refundCancelFm">
  				...
  				<table width="100%" cellpadding="5px" class="maintable">
	  				...
	  				<tr>
  						...
  						<td colspan="9" width="92%">
  							<textarea rows="4" cols="122" id="remark" name="remark" required="true" class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled">${obj.refundFeeObj.remark }</textarea>
  						</td>
	  				</tr>
  				</table>
						...
						<div id="principalViewDiv" style="display: none;">
		  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
				  				...
				  				<tr>
				  					<td align="right" width="10%"><span>审批备注：</span></td>
				  					<td width="90%" colspan="5">
				  						<textarea rows="2" cols="122" id="principalRemark" class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled"></textarea>
				  					</td>
				  				</tr>
		  					</table>
						</div>
