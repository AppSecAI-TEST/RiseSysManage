...
<html>
  	...
  	<body>
  		<div class="easyui-panel" style="min-width:1100px; width:98%;height:auto;" title="短期课退费取消">
  			<form id="refundCancelFm">
  				...
  				<table width="100%" cellpadding="5px" class="maintable">
	  				...
	  				<tr>
	  					...
	  					<td width="15%">
	  						<input id="realAmount" type="text" class="easyui-textbox" style="width: 120px; height: 25px;" readonly="readonly" disabled="disabled" value="${obj.refundFeeObj.realAmount }"/>
	  					</td>
	  				</tr>
	  				<tr>
