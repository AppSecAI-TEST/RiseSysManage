	  						...
	  						<c:if test="${refundVisit.visitType == '001' }">
		  						...
		  						<tr>
		  							...
		  							<td colspan="3" width="90%">
		  								<textarea rows="6" cols="122" id="teacherOrAdviserVisitRemark" name="teacherOrAdviserVisitRemark" required="true" class="easyui-validatebox textbox" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
		  							</td>
		  						</tr>
	  						</c:if>
	  					</c:forEach>
  						...
  						<c:forEach items="${obj.refundVisitList }" var="refundVisit">
	  						<c:if test="${refundVisit.visitType == '002' }">
		  						...
		  						<tr>
		  							<td align="right" width="10%"><span>回访记录：</span></td>
		  							<td colspan="3" width="90%">
		  								<textarea rows="6" cols="122" id="academicOrSalesVisitRemark" name="academicOrSalesVisitRemark" required="true" class="easyui-validatebox textbox" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
		  							</td>
		  						</tr>
	  						</c:if>
	  					</c:forEach>
  						...
  						<c:forEach items="${obj.refundVisitList }" var="refundVisit">
	  						<c:if test="${refundVisit.visitType == '003' }">
		  						...
		  						<tr>
		  							<td align="right" width="10%"><span>回访记录：</span></td>
		  							<td colspan="3" width="90%">
		  								<textarea rows="6" cols="122" id="headmasterVisitRemark" name="headmasterVisitRemark" required="true" class="easyui-validatebox textbox" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
		  							</td>
		  						</tr>
	  						</c:if>
	  					</c:forEach>
