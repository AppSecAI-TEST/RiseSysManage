  			...
  			<form id="refundApproveFm">
  				...
  				<table width="100%" cellpadding="5px" class="maintable">
	  				...
	  				<tr>
	  					...
	  					<td colspan="9" width="92%">
	  						<c:if test="${not empty obj.refundFeeObj.schoolReasonType && not empty obj.refundFeeObj.schoolReason }">
		  						...
		  						<select id="schoolReasonType" name="schoolReasonType" class="easyui-combobox" style="width: 120px; height: 25px;" disabled="disabled"
			        			...
			        			<select id="schoolReason" name="schoolReason" class="easyui-combobox" style="width: 200px; height: 25px;" disabled="disabled"
	  				...
	  				<tr>
  						...
  						<td colspan="9" width="92%">
  							<textarea rows="4" cols="122" id="remark" name="remark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled">${obj.refundFeeObj.remark }</textarea>
  						</td>
	  				</tr>
  				</table>
  				...
  				<c:forEach items="${obj.refundFeeDetailList }" var="refundFeeDetail" varStatus="status">
  					...
  					<input type="hidden" id="refundFeeDetailId${refundFeeDetail.studentCourseId }" name="refundFeeDetailId" value="${refundFeeDetail.refundFeeDetailId }"/>
  					<table width="100%" cellpadding="5px" class="maintables" style="margin-top: 10px;">
  						...
  						<tr>
  							...
  							<td width="8%" align="center">
  								<input id="minusGiftFee${refundFeeDetail.studentCourseId }" name="minusGiftFee" type="text" class="easyui-textbox numberbox" data-options="min:0, max:${refundFeeDetail.refundStageFee }, precision:2" style="width: 80px; height: 25px;" required="true" value="${refundFeeDetail.minusGiftFee }" disabled="disabled"/>
  							</td>
  							<td width="8%" align="center">
  								<input id="minusTextbookFee${refundFeeDetail.studentCourseId }" name="minusTextbookFee" type="text" class="easyui-textbox numberbox" data-options="min:0, max:${refundFeeDetail.refundStageFee }, precision:2" style="width: 100px; height: 25px;" required="true" value="${refundFeeDetail.minusTextbookFee }" disabled="disabled"/>
  							</td>
  							<td width="8%" align="center">
  								<input id="minusCourseFee${refundFeeDetail.studentCourseId }" name="minusCourseFee" type="text" class="easyui-textbox numberbox" data-options="min:0, max:${refundFeeDetail.refundStageFee }, precision:2" style="width: 100px; height: 25px;" required="true" value="${refundFeeDetail.minusCourseFee }" disabled="disabled"/>
							</td>
  							<td width="7%" align="center">
  								<input id="handlingChange${refundFeeDetail.studentCourseId }" name="handlingChange" type="text" class="easyui-textbox numberbox" data-options="min:0, max:${refundFeeDetail.refundStageFee }, precision:2" style="width: 100px; height: 25px;" required="true" value="${refundFeeDetail.handlingChange }" disabled="disabled"/>
  							</td>
  							<td width="8%" align="center">
  								<input id="minusOtherFee${refundFeeDetail.studentCourseId }" name="minusOtherFee" type="text" class="easyui-textbox numberbox" data-options="min:0, max:${refundFeeDetail.refundStageFee }, precision:2" style="width: 100px; height: 25px;" required="true" value="${refundFeeDetail.minusOtherFee }" disabled="disabled"/>
  							</td>
			  						...
			  						<tr>
			  							...
			  							<td width="35%">
	  										<c:if test="${refundVisit.userType == 'teacher' }">
				  								...
				  								<select id="teacherId" name="teacherId" class="easyui-combobox" style="width: 110px; height: 25px;" disabled="disabled"
		      										...
		      										url="<%=path %>/pubData/qryStaffList.do?post=4,5&schoolId=${obj.refundFeeObj.schoolId }">
						        				</select>
				  								<input type="radio" name="visitPersonOne" value="adviser" disabled="disabled"/><span>课程顾问</span>
				  								<select id="careAdviserId" name="careAdviserId" class="easyui-combobox" style="width: 110px; height: 25px;">
						        				</select>
	  										</c:if>
	  										<c:if test="${refundVisit.userType == 'adviser' }">
				  								...
				  								<select id="careAdviserId" name="careAdviserId" class="easyui-combobox" style="width: 110px; height: 25px;" disabled="disabled"
				  									data-options="formatter:formatStaff, valueField: 'staffId', textField: 'userName', panelHeight: 'auto',
			  							...
			  							<td width="45%">
			  								<input name="teacherOrAdviserVisitDate" id="teacherOrAdviserVisitDate" type="text" class="easyui-datebox" required="true" style="width: 110px; height: 25px;" value="${refundVisit.visitDate }" disabled="disabled"/>
			  							</td>
			  						</tr>
			  						<tr>
			  							<td align="right" width="10%"><span>回访记录：</span></td>
			  							<td colspan="3" width="90%">
			  								<textarea rows="4" cols="122" id="teacherOrAdviserVisitRemark" name="teacherOrAdviserVisitRemark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
			  							</td>
			  						</tr>
		  						</c:if>
		  					</c:forEach>
			  						...
			  						<tr>
			  							...
			  							<td width="35%">
			  								<c:if test="${refundVisit.userType == 'academic' }">
				  								...
				  								<select id="academicId" name="academicId" class="easyui-combobox" style="width: 110px; height: 25px;" disabled="disabled"
				  									data-options="formatter:formatStaff, valueField: 'staffId', textField: 'userName', panelHeight: 'auto', 
			  									...
			  									<select id="salesId" name="salesId" class="easyui-combobox" style="width: 110px; height: 25px;" disabled="disabled">
					        					</select>
			  								</c:if>
			  							...
			  							<td align="right" width="10%"><span>回访时间：</span></td>
			  							<td width="45%">
			  								<input name="academicOrSalesVisitDate" id="academicOrSalesVisitDate" type="text" class="easyui-datebox" required="true" style="width: 110px; height: 25px;" disabled="disabled" value="${refundVisit.visitDate }"/>
			  							</td>
			  						</tr>
			  						<tr>
			  							<td align="right" width="10%"><span>回访记录：</span></td>
			  							<td colspan="3" width="90%">
			  								<textarea rows="4" cols="122" id="academicOrSalesVisitRemark" name="academicOrSalesVisitRemark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
			  							</td>
			  						</tr>
		  						</c:if>
		  					</c:forEach>
	  						...
	  						<c:forEach items="${obj.refundVisitList }" var="refundVisit">
		  						<c:if test="${refundVisit.visitType == '003' }">
			  						...
			  						<tr>
			  							<td align="right" width="10%"><span>回访人员：</span></td>
			  							<td width="8%">
			  								<select id="headmasterId" name="headmasterId" class="easyui-combobox" style="width: 100px; height: 25px;" disabled="disabled"
												data-options="formatter:formatStaff, valueField: 'staffId', textField: 'userName', panelHeight: 'auto',
			  							...
			  							<td width="74%">
			  								<input name="headmasterVisitDate" id="headmasterVisitDate" type="text" class="easyui-datebox" style="width: 100px; height: 25px;" disabled="disabled" value="${refundVisit.visitDate }"/>
			  							</td>
			  						</tr>
			  						<tr>
			  							<td align="right" width="10%"><span>回访记录：</span></td>
			  							<td colspan="3" width="90%">
			  								<textarea rows="4" cols="122" id="headmasterVisitRemark" name="headmasterVisitRemark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled">${refundVisit.remark }</textarea>
			  							</td>
			  						</tr>
		  						</c:if>
		  					</c:forEach>
  					...
  					<div id="headmasterApproveDiv" style=" display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					...
			  					<td width="92%">
			  						<textarea rows="4" cols="122" name="approveRemark"  class="textarea easyui-validatebox" validType="length[0,120]"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
	  					...
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					...
			  					<td width="92%" colspan="5">
			  						<textarea rows="2" cols="122" id="headmasterRemark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
					...
					<div id="academicOrSalesViewDiv" style=" display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					<td align="right" width="8%"><span>审批备注：</span></td>
			  					<td width="92%" colspan="5">
			  						<textarea rows="2" cols="122" id="academicOrSalesRemark"  class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
					...
					<div id="regionalPresidentViewDiv" style=" display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					<td align="right" width="8%"><span>审批备注：</span></td>
			  					<td width="92%" colspan="5">
			  						<textarea rows="2" cols="122" id="regionalPresidentRemark" class="textarea easyui-validatebox" validType="length[0,120]" readonly="readonly" disabled="disabled"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
					...
					<div id="principalApproveDiv" style=" display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					<td align="right" width="8%"><span>审批备注：</span></td>
			  					<td width="92%">
			  						<textarea rows="4" cols="122" name="approveRemark" class="textarea easyui-validatebox" validType="length[0,120]" validType="length[0,120]"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
					...
					<div id="headquartersFinancialApproveDiv" style=" display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					...
			  					<td width="80%">
			  						<input name="belongDate" id="belongDate" type="text" class="easyui-datebox" style="width: 110px; height: 25px;"/>
			  					</td>
			  				</tr>
			  				<tr>
