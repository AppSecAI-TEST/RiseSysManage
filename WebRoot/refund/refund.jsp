			  				...
			  				<td width="100px">
								<select id="schoolId" name="schoolId" class="easyui-combobox" style="width: 100px; height: 25px;" editable="false"
									data-options="formatter:formatSchool, valueField: 'schoolId', textField: 'schoolName', panelHeight: 'auto',
					      			...
					      			url="<%=path %>/pub/pageCategory.do?staffId=${sessionScope.StaffT.staffId}&funcNodeId=${param.funcNodeId}&fieldId=schoolId&resourceId=252">
				        		</select>
							</td>
    		...
    		<div title="退费审批管理" style="padding:5px;display:block;">
			  				...
			  				<td width="100px">
								<select id="approveSchoolId" name="approveSchoolId" class="easyui-combobox" style="width: 100px; height: 25px;" editable="false"
									data-options="formatter:formatSchool, valueField: 'schoolId', textField: 'schoolName', panelHeight: 'auto',
					      			...
					      			url="<%=path %>/pub/pageCategory.do?staffId=${sessionScope.StaffT.staffId}&fieldId=schoolId">
				        		</select>
							</td>
							<td align="right"><span>联系电话：</span></td>
							<td width="100px">
    			...
    			<div style="padding:5px 0;min-width:1100px; width:100%;">
			  	...
			  	<div id="toolbarApprove" style="padding: 2px; height: auto">
			  		<a href="javascript:void(0)" id="refundApply" class="easyui-linkbutton" iconCls="icon-add" style="width: 80px;">退费申请</a>
			  		<a href="javascript:void(0)" id="refundApprove" class="easyui-linkbutton" iconCls="icon-add" style="width: 80px;">退费审批</a>
		   			...
		   			<a href="javascript:void(0)" id="refundApplyAgain" class="easyui-linkbutton" iconCls="icon-add" style="width: 80px;">重新申请</a>
				</div>
    		</div>
    	</div>
  	</body>
