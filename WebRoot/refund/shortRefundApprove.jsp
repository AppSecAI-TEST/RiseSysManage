  	...
  	<body>
  		<div class="easyui-panel" style="min-width:1100px; width:98%;height:auto;" title="短期课退费审批">
  			<form id="refundApproveFm">
  				...
  				<input type="hidden" id="refundImgUrl" value="${obj.refundFeeObj.url }"/>
  				...
  				<table width="100%" cellpadding="5px" class="maintable">
	  				...
	  				<tr id="refundWayTr">
		  				...
		  				<td width="15%">
		  					<input id="bankCard" name="bankCard" type="text" class="easyui-textbox" style="width: 180px; height: 25px;" value="${obj.refundFeeObj.bankCard }" disabled="disabled"/>
		  				</td>
	  				...
	  				<tr>
	  					...
	  					<td width="15%">
	  						<input id="realAmount" type="text" class="easyui-textbox" style="width: 120px; height: 25px;" value="${obj.refundFeeObj.realAmount }" disabled="disabled" readonly="readonly"/>
	  					</td>
	  				</tr>
	  				<tr>
  				...
  				<div class="easyui-panel" style="min-width:1100px; width:100%;height:auto;" title="审批信息">
  					<div id="financialApproveDiv" style="display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
			  				...
			  				<tr>
			  					...
			  					<td width="92%">
			  						<textarea rows="4" cols="122" id="approveRemark" name="approveRemark" class="textarea easyui-validatebox" validType="length[0,120]"></textarea>
			  					</td>
			  				</tr>
	  					</table>
					</div>
					...
					<div id="headquartersFinancialApproveDiv" style="display: none;">
	  					<table width="100%" cellpadding="5px" style="border-collapse: collapse; border-spacing:0; border: 1px solid #ccc; height:auto;">
	  						<tr>
			  					<td colspan="4"><span>3、总部财务打款信息：</span></td>
			  				</tr>
			  				<tr>
