		...
		<div id="mainarea" class="easyui-layout" data-options="region:'center'" style="padding:0px;background:#E0ECFF;min-width:300px">
			<table region="north" class="queryArea" split="true" align="center" style="height:30px;width:100%;min-width:1000px;">
				<tr>
					...
					<td><select id="deptId" name="deptId" style="width:150px" ></select></td>
					<td align="right">英文名:</td>
					<td><input name="userName" id="userName" type="text" style="width:150px" class="easyui-textbox" /></td>
					<td align="right">职务:</td>
					<td><select id="post" name="post" style="width:100px" ></select></td>
					<td align="right">状态:</td>
					<td><select id="staffState" name="staffState" style="width:100px" ></select></td>
