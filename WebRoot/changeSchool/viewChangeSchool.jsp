...
<html>
  	<head>
		...
		<script type="text/javascript" src="<%=path %>/js/changeSchool/view.js"></script>
  	</head>
  	...
  	<body>
  		...
  		<div class="easyui-panel" style="min-width:1100px; width:99%;height:auto;" title="浏览转校信息">
  			...
  			<table width="100%" cellpadding="5px" class="maintable">
  				<tr>
  					<td align="right" width="10%"><span>转校状态：</span></td>
  					<td width="12%"><span id="changeStateText"></span></td>
  					<td align="right" width="10%"><span>转出校区：</span></td>
  					<td width="12%"><span id="outSchoolNameText"></span></td>
  					<td align="right" width="12%"><span>原在读班级：</span></td>
  					<td width="44%" colspan="3"><span id="outClassNameText"></span></td>
  				</tr>
  				<tr>
  					<td align="right" width="10%"><span>在读课程状态：</span></td>
  					<td width="12%"><span id="courseStateText"></span></td>
  					<td align="right" width="10%"><span>转入校区：</span></td>
  					<td width="12%"><span id="inSchoolNameText"></span></td>
  					<td align="right" width="12%"><span>转入班级：</span></td>
  					<td width="44%" colspan="3"><span id="inClassNameText"></span></td>
  				</tr>
  				<tr>
  					<td align="right" width="10%"><span>已结课阶段：</span></td>
  					<td width="12%"><span id="finishStageIdText"></span></td>
  					<td align="right" width="10%"><span>已升学阶段：</span></td>
  					<td width="12%"><span id="higherStageIdText"></span></td>
  					<td align="right" width="12%"><span>当前课程：</span></td>
  					<td width="10%"><span id="stageIdText"></span></td>
  					<td align="right" width="14%"><span>当前课程业绩类型：</span></td>
  				...
  				<tr id="approveTr" style="display: none;">
  					...
  					<td align="right" width="14%"><span>审批说明：</span></td>
