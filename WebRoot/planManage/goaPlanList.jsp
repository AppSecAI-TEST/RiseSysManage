 		...
 		<form id="qryFm">
  			<table align="center" style="min-width:1100px;width:99%;border:1px solid #95B8E7;margin-top:10px;font-family:'微软雅黑'" cellspacing="15">
  				<tr>
  					...
  					<td>
  						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" style="width:150px" id="qryBtn" funcNodeId="3603"><span>查询</span></a>
  						&nbsp;&nbsp;
  			...
  			<form id="fm">
  				<table style="width: 100%;" cellSpacing='0' cellPadding='16'>
  					...
  					<tr>
  						...
  						<td>
	  						<select class="easyui-combobox" name="planYear" id="planYear" style="width:205px;"
