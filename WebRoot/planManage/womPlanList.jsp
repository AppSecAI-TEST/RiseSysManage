...
<html>
  	<head>
		...
		<script type="text/javascript" src="<%=path %>/js/planManage/womPlanList.js"></script>
  	</head>
  	<body>
  				...
  				<tr>
  					...
  					<td width="110px">
  						<select class="easyui-combobox" name="schoolId" id="schoolId" style="width:100px;height: 25px;"
  							...
  							url="<%=path%>/pub/pageCategory.do?staffId=${sessionScope.StaffT.staffId}&resourceId=709&fieldId=schoolId&headFlag=N">
  					...
  					<td>
  						<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" style="width:100px" id="qryBtn" funcNodeId="3602"><span>查询</span></a>
  						&nbsp;&nbsp;
 		...
 		<table class="easyui-datagrid" align="center" title="查询结果" data-options="height:450" id="list_data" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true">
			<thead>
				<tr>
					...
					<th field="firstValue" align="center" width="38%"><span>计划口碑(个数)</span></th>
				</tr>
			</thead>
		</table>
 		...
 		<div id="dlg" class="easyui-dialog" style="width: 580px; height: 350px; padding: 10px 20px" closed="true" data-options="modal:true" buttons="#dlgBtn">
  			<form id="fm">
  				<table style="width: 100%;" cellSpacing='0' cellPadding='16'>
  					...
  					<tr>
  						<td style="text-align: right;"><span>计划口碑（个数）：</span></td>
  						<td>
