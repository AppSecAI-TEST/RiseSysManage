		...
		<input id="operate" type="hidden" value="<%=operate%>"/>
  			<table id ="infoTab" width="100%;" class="maintable">
  				...
  				<tr>
  					...
  					<td align="left" colspan="2">
  						  <input type="text" class="easyui-numberbox" id="realHours" name="realHours" data-options="min:1,max:24,precision:0"  style="width:100px;height: 28px;">
  					</td>
  				</tr>
  				<tr id="addInfo">
  					...
  					<td align="left">
  						...
  						&nbsp;&nbsp;
  						<input type="text" class="easyui-numberbox" id="hours" name="hours" data-options="min:1,max:24,precision:0"  style="width:100px;height: 28px;">
  					</td>
