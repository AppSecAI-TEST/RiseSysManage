...
<html>
  	...
  	<body>
  		...
  		<div class="easyui-panel" style="min-width:1100px; width:99%;height:auto;padding:5px;display:block;" title="教材配置">
			<table align="center" title="查询结果" data-options="height:600" id="textbook_data">
				
			</table>
			<div id="textbookToolbar">
	   			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" onclick="addTextbook()">添加教材</a>
	 		</div>
			...
			<div id="textbook-buttons">
				<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveTextbookSubmit()">提交</a>
				<a href="#" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#textbookDlg').dialog('close')">取消</a>
			</div>
  		</div>
  	</body>
</html>
