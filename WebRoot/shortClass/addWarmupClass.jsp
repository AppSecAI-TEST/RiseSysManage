		...
		<script type="text/javascript">
			...
			function addSubmitFunc()
			{
				...
				else
				{
					...
					$.post("/sys/shortBus/addShortClassInstTInfo.do",{jsonClass:JSON.stringify(json),jsonSchooltimeGroup:sessionStorage.getItem("shortSchooltimeTArr"),className:encodeURI("热身课")},function(data){
						ajaxLoadEnd();
						if(data == "success")
						{
  	...
  	<body class="manage">
 		...
 		<div class="panel datagrid easyui-fluid" style="width:99%">
		  <div class="panel-header">
		    <div class="panel-title">新增热身课</div>
