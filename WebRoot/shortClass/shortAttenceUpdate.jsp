...
<html>
  	...
  	<body class="manage">
		...
		<script type="text/javascript">
			...
			function backFunc()
			{
				window.location.href = "/sys/shortBus/shortAttenceDetailPage.do?funcNodeId=${funcNodeId}&shortClassInstId=${shortClassAttendT.shortClassInstId}&pageName=shortAttenceInterDetail";
			}
		</script>
 	</body>
</html>