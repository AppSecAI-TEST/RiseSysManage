...
<html>
  	...
  	<body>
  		...
  		<div class="easyui-panel" style="min-width:1101px; width:100%; height:auto; " title="放班操作历史信息">
  			<table class="easyui-datagrid" style="height: auto; width: 100%" id="list_data" fitColumns="true" singleSelect="false"
  				url="<%=path %>/pubData/qryData.do?param={'applyId':'${obj.createClassObj.applyId }','funcNodeId':'1008'}">
				<thead>
					<tr>
