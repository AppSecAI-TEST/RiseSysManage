  	...
  	<body>
		<form id="attFm" style="margin:0 auto;">
			<c:choose>
				...
				<c:otherwise>
					<table align="center" class="tab" style="min-width:2000px;margin:0 auto;padding:0 0;border-top:1px solid #ccc;border-left:1px solid #ccc;height:auto">
						<tr class="headTr">
							<td rowspan="2">序号</td>
						...
						<tr>
							<td colspan="${maxDay+4}" align="right" style="border:none;padding-right:5px;padding-top:5px">
