  			...
  			<form id="qryFm">
  				<table class="search_tab">
  					<tr>
	  					...
	  					<td align="right" style="min-width: 40px;"><span>老师：</span></td>
						<td style="min-width: 100px;">
							<select id="teacherId" name="teacherId" class="easyui-combobox" style="width: 110px; height: 25px;"></select>							
						</td>
						...
						<td style="min-width: 210px;">
							<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" style="width:100px; height: 25px;" id="qryBtn" funcNodeId="1103">查询</a>
  			...
  			<table class="easyui-datagrid" style="height:435px;" id="list_data"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'teacherName',width:'8%',align:'center'">教师中文名</th>
						<th data-options="field:'byname',width:'8%',align:'center'">教师英文名</th>
						<th data-options="field:'attendRate1',width:'10%',align:'center'">1月出勤率</th>
						<th data-options="field:'attendRate2',width:'10%',align:'center'">2月出勤率</th>
						<th data-options="field:'attendRate3',width:'10%',align:'center'">3月出勤率</th>
						<th data-options="field:'attendRate4',width:'10%',align:'center'">4月出勤率</th>
						<th data-options="field:'attendRate5',width:'10%',align:'center'">5月出勤率</th>
						<th data-options="field:'attendRate6',width:'10%',align:'center'">6月出勤率</th>
						<th data-options="field:'attendRate7',width:'10%',align:'center'">7月出勤率</th>
						<th data-options="field:'attendRate8',width:'10%',align:'center'">8月出勤率</th>
						<th data-options="field:'attendRate9',width:'10%',align:'center'">9月出勤率</th>
						<th data-options="field:'attendRate10',width:'10%',align:'center'">10月出勤率</th>
						<th data-options="field:'attendRate11',width:'10%',align:'center'">11月出勤率</th>
						<th data-options="field:'attendRate12',width:'10%',align:'center'">12月出勤率</th>
					</tr>
				</thead>
			</table>
