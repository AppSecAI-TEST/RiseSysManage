				...
				<table class="easyui-datagrid" title="查询结果" style="width:100%;height:250px" id="list_data" fitColumns="true">
					<thead>
						<tr>
							...
							<th field="enterNum" align="center" width="10%">结课后14天内进班人数</th>
							<th field="waitNum" align="center" width="10%">结课等班人数</th>
							<th field="rate" align="center" width="10%">14天内结课进班占比</th>
						</tr>
					</thead>
				</table>
			</div>
