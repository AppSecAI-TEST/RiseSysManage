  			...
  			<form id="qryFm">
	  			<table>
	  				...
	  				<tr>	
	  					...
	  					<td>未完成原因：</td>
	  					<td>
	  						<select class="easyui-combobox" name="undoReason" id="undoReason" style="width:150px;">
				...
				<table class="easyui-datagrid" title="查询结果" style="width:100%;height:250px" id="list_data" fitColumns="true">
					<thead>
						<tr>
							...
							<th field="event" align="center" width="20%" >教质事件</th>
							<th field="reason" align="center" width="30%" >未完成原因</th>
						</tr>
					</thead>
				</table>
			</div>
