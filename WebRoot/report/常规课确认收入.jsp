  			...
  			<form id="qryFm" style="margin:0 auto;">
	  			<table align="center" style="min-width:1100px;width:99%;border:1px solid #95B8E7;font-family:'微软雅黑';margin:0 auto;height:80px;" cellspacing="2">
	  				<tr>
	  					...
	  					<td align="right" width="100px"><span>退费原因：</span></td>
	  					<td align="left"  width="120px">
	  						<select id="stageId" name="reasonType" class="easyui-combobox" style="width: 114px; height: 25px;"
				...
				<table class="easyui-datagrid" style="height:435px;" id="list_data"
					...
					<thead>
						<tr>
							...
							<th field="typeVal" align="center" width="8%">大类</th>
							<th field="reasonVal" align="center" width="8%">细分</th>
