  	...
  	<body>
  		<div class="easyui-panel" style="min-width:1100px; width:99%;height:auto;" title="券类赠品作废">
  			...
  			<table width="100%" cellpadding="5px" class="maintable">
  				...
  				<tr>
  					<td align="right"><span>作废说明：</span></td>
 		...
 		<div style="margin-top: 20px;min-width:1100px; width:99%;">
	      	<div style="text-align:center">
	      		<a href="javascript:void(0)" id="couponInvalidateSubmit" class="easyui-linkbutton" iconCls="icon-ok" style="width:100px;" onclick="couponInvalidateSubmit()"><span>提交</span></a>
	      		&nbsp;
