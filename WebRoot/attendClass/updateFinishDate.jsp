...
<html>
  	<head>
		...
		<script type="text/javascript" src="<%=path %>/js/attendClass/updateFinishDate.js"></script>
  	</head>
  
  	<body>
  		<input type="hidden" id="oldFinishDate" value="${obj.attendClassObj.finishDate }"/>
	  			...
	  			<table width="99.99%" cellpadding="5px" class="maintable">
	  				...
	  				<tr>
		  				<td colspan="6" align="right">
		  					<a href="javascript:void(0)" id="updateFinishDateSubmit" class="easyui-linkbutton" iconCls="icon-ok" style="width: 80px; height: 28px;">提交</a>
