      	...
      	<div class="easyui-panel" style="min-width:1100px; width:99%;height:auto;" title="活动信息">
      		<form id="activityFm">
      			...
      			<table width="100%" cellpadding="5px" class="maintable" id="addActivityTd">
      				...
      				<tr id="giftModelTR">
      					<td align="right" width="8%"><span>赠品类别：</span></td>
      					<td align="center" width="8%">
      						<select id="giftType" class="easyui-combobox" style="width: 100px; height: 28px;">
        					</select>
      					</td>
      					<td align="right" width="8%"><span>赠品名称：</span></td>
      					<td width="38%" align="left" id="otherTd">
      						<select id="giftName" class="easyui-combobox" style="width: 100px; height: 28px;"></select>
      					</td>
      					<td width="38%" align="left" id="couponTd" style="display: none;">
      					...
      					<td align="right" width="8%"><span>是否领取：</span></td>
      					<td width="10%" align="left">
      	       		 		<input type="radio" value="Y" name="isGet"/><span>已领</span>
      						&nbsp;<input type="radio" value="N" name="isGet"/><span>未领</span>
     	           		</td>
     	           		<td align="right" width="6%"><span>发放人：</span></td>
      	        		<td width="7%">
      	        			<input id="granter" type="text" class="easyui-textbox validatebox" style="width: 100px; height: 28px;"/>
      	        		</td>
