...
//			settings.onDialogClose.apply(this, [this.queueData]);
    },
...
//        alert("getUploadifyCfg-->me.id="+me.id);
        var cfg = {
            ...
            swf : '/pub/js/uploadify/uploadify.swf',//上传按钮的图片，默认是这个flash文件
            uploader : '/file/upload.do;jsessionid='+me.SESSIONID,//上传所处理的服务器
            cancelImg : '/pub/js/uploadify/uploadify-cancel.png',//取消图片
            method : 'post',
            folder : '/pub/file',//上传后，所保存文件的路径
