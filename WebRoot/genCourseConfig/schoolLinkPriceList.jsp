...
<html>
	...
	<body>
		...
		<div style="margin-top: 10px;text-align:center;">
	      	<a href="javascript:void(0)" id="back" class="easyui-linkbutton" iconCls="icon-back" style="width:100px;" onclick="javascript:parent.window.$('#linkDlg').dialog('close')"><span>返回</span></a>
	     </div>
	</body>
</html>