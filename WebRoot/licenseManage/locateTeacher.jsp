...
<html>
  	...
  	<body>
		...
		<div id="toolbar" style="padding: 2px;height:auto;">
   			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" style="width:100px;" onclick="addLicense()"><span>提交</span></a>
 		...
 		<script type="text/javascript">
	   		$(document).ready(function(){
				...
				$("#schoolId").combobox({
					url : "/sys/pub/pageCategory.do?staffId="+staffId+"&resourceId=507&fieldId=schoolId&headFlag=N",//返回json数据的url 
					valueField : "schoolId",
