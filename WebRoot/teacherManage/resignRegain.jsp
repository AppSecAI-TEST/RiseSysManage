  		...
  		<div class="easyui-panel" style="min-width:1100px; width:99%;height:auto;" title="教师档案信息">
 			...
 			<input id="handlerId" type="hidden" value="${sessionScope.StaffT.staffId}"/>
  			<table width="100%" cellpadding="5px" class="maintable" id="teacherTd">
  				...
  				<tr>
  					<td align="right">离职操作时间：</td>
  					<td align="left">${retObj.lInfo.createDate}</td>
  					<td align="right">操作人：</td>
  					<td align="left">${retObj.lInfo.handlerName}</td>
  					<td align="right"></td>
  					<td align="left"></td>
  				</tr>
  				<tr>
	 				<td align="right">预离职备注：</td>
 				...
 				<tr>
	 				<td align="right">离职备注：</td>
	 				<td colspan="5"><textarea rows="7" cols="100" id="rRemark" name="rRemark" readonly="readonly" class="easyui-validatebox textbox">${retObj.lInfo.description}</textarea></td>
 				</tr>
 				<tr>
	 				<td align="right">离职复职备注：</td>
	 				<td colspan="5"><textarea rows="7" cols="100" id="lpRemark" name="lpRemark" class="easyui-validatebox textbox"></textarea></td>
 				</tr>
  			</table>
  		</div>
 		<div style="margin-top: 20px;min-width:1100px; width:99%;">
	      	<div style="float: right;">
	      		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" style="width: 80px; height: 28px;" onclick="resignRegainSubmit()">提交</a>
	      		&nbsp;
