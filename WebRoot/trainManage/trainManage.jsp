 		...
 		<form id="qryFm">
  			<table align="center" style="min-width:1100px;width:99%;border:1px solid #95B8E7;margin-top:10px;font-family:'微软雅黑'" cellspacing="5">
  				<tr>
  					...
  					<td align="left" width="10%">
  						<input class="easyui-datebox" name="trainStartDate" id="trainStartDate" style="width:120px;" />
  					</td>
  					<td align="center" width="3%">至：</td>
  					<td align="left">
  						<input class="easyui-datebox" name="trainEndDate" id="trainEndDate" style="width:120px;" />
  					</td>
  					<td></td>
  				</tr>
  				<tr>
  					...
  					<td align="left">
  						<input name="reparation" type="checkbox" value="Y" style="margin:0 auto;vertical-align:middle;" /><span>是</span>
  						&nbsp;&nbsp;&nbsp;<input name="reparation" type="checkbox" value="N" style="margin:0 auto;vertical-align:middle;" /><span>否</span>
		...
		<table class="easyui-datagrid" align="center" title="查询结果" data-options="height:570" id="list_data" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
			<thead>
				<tr>
					...
					<th field="stateVal" align="center" width="8%">开始时间</th>
					<th field="licenses" align="center" width="12%">结束时间</th>
					<th field="licensesNum" align="center" width="7%">培训费用</th>
					<th field="stageIds" align="center" width="11%">若现离职赔付金额</th>
					<th field="stateVal" align="center" width="11%">教师状态</th>
					<th field="rate" align="center" width="23%">培训概述</th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
