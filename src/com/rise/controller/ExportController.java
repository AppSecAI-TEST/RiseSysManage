...
public class ExportController {
	...
	public void normalExport(String fileName, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		...
		try {
			...
			es.normalExport(fileName, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void normalMergeExport(String fileName, String mergeName, String mergeIndex, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.normalMergeExport(fileName, mergeName, mergeIndex, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportSchoolMSGradRate(String fileName, String year, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.exportSchoolMSGradRate(fileName, year, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportCenterGradeRate(String fileName, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.exportCenterGradeRate(fileName, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportCenterMSRate(String fileName, String year, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.exportCenterMSRate(fileName, year, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportLackOfGradRate(String fileName, String year, String quarter, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.exportLackOfGradRate(fileName, year, quarter, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportRegionGradRate(String fileName, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
			...
			response.setHeader("Content-Disposition", "attachment;fileName=" + URLEncoder.encode(displayFileName.toString(), "utf-8"));
			out = response.getOutputStream();
			es.exportRegionGradRate(fileName, param, funcNodeId, out);
		} catch (Exception err) {
			err.printStackTrace();
		}
	}
	...
	public void exportExpClassDetai(String fileName, String param, String funcNodeId, HttpServletResponse response, HttpServletRequest request) {
		OutputStream out = null;
		try {
			StringBuffer displayFileName = new StringBuffer(fileName);
			displayFileName.append(new SimpleDateFormat("yyMMdd").format(new Date()));
