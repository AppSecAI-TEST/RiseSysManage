...
public class LeaveManageService {
	...
	//休学延长
	public String prolong(String leaveId, String prolongTime, String prolongRemark, String handlerId) throws Exception {
		String param = "{channel:\"Q\",channelType:\"PC\",serviceType:\"BUS1206\",securityCode:\"0000000000\",params:{param:{leaveId:\"" + leaveId + "\",prolongTime:\"" + prolongTime + "\",prolongRemark:\"" + prolongRemark + "\",handlerId:\"" + handlerId + "\"}},rtnDataFormatType:\"user-defined\"}";
		return ServiceEngine.invokeHttp(param);
	}
}
